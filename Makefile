...
kernel: kernel.o loader.o vid_boottext.o hw_interrupt.o
	ld -melf_i386 -T linker.ld -o kernel.bin loader.o kernel.o vid_colortext.o hw_interrupt.o vid_boottext.o
